...
/*
 * Things that we updated - Using the preferred jQuery plugin pattern - Added
 * references to all elements - Removed flash based image - Added fallback
 * method - Fixed onInit event - Added onDisable and onEnable events - SWFObject
 * for flash detection - Added indication of cancelled files
 */
