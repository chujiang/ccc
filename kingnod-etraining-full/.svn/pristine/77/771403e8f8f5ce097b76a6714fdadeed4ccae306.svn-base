...
public class LearnerListRefreshServiceJob extends QuartzJobBean {
	...
	protected void handle(){
		EnrollLearnerService enrollLearnerService = SpringUtils.getBean(EnrollLearnerService.class);
		enrollLearnerService.refreshAllEnrollLearnerMember();
	}
