 ...
 */
-->
<#if parameters.isLinksChildren?if_exists == true>
c[c.length]='<#rt/>
</#if>
...
<#if parameters.disabled?if_exists == "true"> 
...
><#if parameters.body??>${parameters.body}</#if><#rt/>
<#if parameters.text??>
...
<#if parameters.isLinksChildren?if_exists == true>';</#if>