...
@Results( 
{
@Result(name = EntityAction.RELOAD, type = "redirectAction", params = { "actionName", "training-plan-reports", "namespace", "/aty"})
}
)
public class TrainingPlanReportsAction extends FilterableEntityAction<TrainingPlan, Long>{
